...
if __name__ == '__main__':
	...
	prop_array = [prop_array[i+1:args.n+i+1] for i in range(len(prop_array)-(args.n +1))]
	...
	# print(tuple(itertools.permutations(prop_array))) permutatie functie voor opdracht 4
